    ...
    const createTimesheetRoutes = (isAuthenticated) => {
      ...
      router.get("/edit/:id", isAuthenticated, async (req, res) => {
        ...
        try {
          ...
          if (userScheduleResponse.data.length !== 0) {
            ...
            userSchedules = getPayPeriods(new Date(startDate), new Date(endDate), scheduleDays, paidHours, userScheduleResponse);
          }
      ...
      function getPayPeriods(startDate, endDate, scheduleDays, paidHours, userScheduleResponse) {
